...
module ALUControl(
    ...
    always @(*) begin
        case (aluOp)
            ...
            // LW, SW, JALR address calculation
            // ADD = 0110
            2'b00: begin
                aluControlSignal = 4'b0110;
            end

            // BEQ comparison and BNE
            // SUB = 0111
            2'b01: begin
            ...
            2'b11: begin
                case (funct3)
                    ...
                    3'b000: aluControlSignal = 4'b0110; // ADDI
                    3'b111: aluControlSignal = 4'b0000; // ANDI
                    3'b101: aluControlSignal = 4'b0101; // SRLI
