...
## Reset (btnC - centre button) ? rst
set_property PACKAGE_PIN U18     [get_ports rst]
set_property IOSTANDARD LVCMOS33 [get_ports rst]

## btn_rst (btnU - up button) ? reset button read at 0x350
...
## Seven-segment display segments seg[6:0]
...
## Seven-segment anode an[3:0] (active low)
